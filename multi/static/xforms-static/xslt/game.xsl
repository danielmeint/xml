                    ...
                    <g id="dealer">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:for-each select="$dealer/hand/card">
                                        <use
                                            href="/static/xforms-static/svg/cards.svg#{@value}_{@suit}"
                        ...
                        <xsl:if test="$dealer/hand/card[1]/@value > 0">
                            <g class="label">
                                ...
                                <text class="name" x="30px" y="85px"> Dealer </text>
                                <text class="hand_value" x="30px" y="115px"
                            ...
                            <g id="player_{position()}_of_{count(/game/player)}">
                                ...
                                <xsl:if test="bet > 0">
                                    <g viewBox="0 0 100 100">
                                        <xsl:choose>
                                            <xsl:when test="@state = 'won' or @state = 'tied'">
                                                <xsl:attribute name="style">animation: chip-won 1s
                                                  ease-in forwards</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="@state = 'lost'">
                                                <xsl:attribute name="style">animation: chip-lost 1s
                                                  ease-in forwards</xsl:attribute>
                                            </xsl:when>
                                        </xsl:choose>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="bet >= 100">
                                                <xsl:attribute name="class">bet chip
                                                  chip-100</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="bet >= 25">
                                                <xsl:attribute name="class">bet chip
                                                  chip-25</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="bet >= 10">
                                                <xsl:attribute name="class">bet chip
                                                  chip-10</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="bet >= 5">
                                                <xsl:attribute name="class">bet chip
                                                  chip-5</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="bet >= 1">
                                                <xsl:attribute name="class">bet chip
                                                  chip-1</xsl:attribute>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:attribute name="class">bet chip</xsl:attribute>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <use href="/static/xforms-static/svg/chips.svg#chip"
                                            width="50" height="50"/>
                                    ...
                                    <xsl:if test="@insurance = 'true'">
                                        <g>
                                            <xsl:attribute name="class">bet chip
                                                chip-insurance</xsl:attribute>
                                            <xsl:if
                                                test="@state = 'won' or @state = 'tied' or @state = 'lost'">
                                                <xsl:attribute name="style">visibility:
                                                  hidden</xsl:attribute>
                                            </xsl:if>
                                            <use href="/static/xforms-static/svg/chips.svg#chip"
                                                width="40" height="40"
                                                transform="translate(40, -30)"/>
                                            <text x="20" y="20" alignment-baseline="central"
                                                transform="translate(40, -30)">
                                ...
                                <g>
                                    <xsl:choose>
                                        <xsl:when test="@name = $name">
                                            <xsl:attribute name="class">label self</xsl:attribute>
                                        </xsl:when>
                                        <xsl:otherwise>
                                    ...
                                    <rect x="10px" y="110px" rx="15" ry="15"
                                        width="{string-length(@name)*5 + 60}px" height="65"/>
                                    <text class="name" x="27px" y="125px">
                                        <xsl:value-of select="@name"/>
                                    </text>
                                    <xsl:if test="hand/@value &gt; 0">
                                        <text class="hand_value" x="27px" y="170px"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <xsl:value-of select="hand/@value"/>
                                        </text>
                                    </xsl:if>

                                    <text class="balance" x="27px" y="142px"
                                        xmlns="http://www.w3.org/2000/svg"> $<xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                  ...
                                                  <xsl:value-of
                                                  select="balance - bet - ceiling(bet div 2)"/>
                                                  </xsl:when>
                                                  <xsl:otherwise>
                ...
                <div class="functions">
                    <xsl:choose>
                        <xsl:when test="$self">
                            ...
                            <form class="top left"
                                action="/xforms-multiclient/games/{/game/@id}/leave" method="post"
                                target="hiddenFrame">
                                <button class="btn btn-secondary" type="submit"> Leave </button>
                            </form>
                            <xsl:choose>
                                <xsl:when
                                    test="(/game/@state = 'betting' or /game/@state = 'playing') and $self/@state = 'inactive'">
                                    <!-- Player is inactive -->
                                    <div class="lds-ellipsis flex-center">
                                        <div/>
                                        <div/>
                                        <div/>
                                        <div/>
                                    </div>
                                    <span><xsl:value-of select="$activePlayer/@name"/>&#xA0;is&#xA0;<xsl:value-of select="/game/@state"/>...</span>
                                </xsl:when>

                                <xsl:when
                                    test="/game/@state = 'betting' and $self/@state = 'active'">
                                    <!-- Betting stage -->
                                    <div class="dialog animation" id="shadow">
                                        <div class="dialog--header"> Place your bets! </div>
                                        <div class="dialog--betting">
                                            <form class="join"
                                                action="/xforms-multiclient/games/{/game/@id}/bet"
                                ...
                                <xsl:when
                                    test="/game/@state = 'playing' and $self/@state = 'active'">
                                    <!-- Playing stage -->
                                    <div class="dialog" id="buttongroup">
                                        <div class="dialog--header">
                                            <xsl:value-of
                                                select="game/player[@state = 'active']/@name"/>
                                        </div>
                                        <div class="buttongroup">
                                            <div>
                                                <form
                                                  action="/xforms-multiclient/games/{/game/@id}/stand"
                                                  method="POST" target="hiddenFrame">
                                            ...
                                            <div>
                                                <xsl:if test="$self/hand/@value &lt; 21">
                                                  <form
                                                  action="/xforms-multiclient/games/{/game/@id}/hit"
                                                  method="POST" target="hiddenFrame">
                                            ...
                                            <div>
                                                <xsl:if
                                                  test="count($self/hand/card) &lt; 3 and $self/@insurance = 'false' and $self/hand/@value &lt; 21 and $self/balance &gt;= $self/bet * 2">
                                                  <form
                                                  action="/xforms-multiclient/games/{/game/@id}/double"
                                                  method="POST" target="hiddenFrame">
                                                  <button class="double" type="submit"
                                                  >Double</button>
                                                  </form>
                                                </xsl:if>
                                            </div>
                                            <div>
                                                <xsl:choose>
                                                  <xsl:when
                                                  test="$activePlayer/bet * 1.5 &gt; $activePlayer/balance or $dealer/hand/card[1]/@value != 'A' or $activePlayer/@insurance = 'true'"> </xsl:when>
                                                  <xsl:otherwise>
                                                  <form
                                                  action="/xforms-multiclient/games/{/game/@id}/insurance"
                                                  method="POST" target="hiddenFrame">
                                                  <button class="insurance" type="submit"
                                                  >Insurance</button>
                                                  </form>
                                                  </xsl:otherwise>
                                                </xsl:choose>
                                ...
                                <xsl:when test="/game/@state = 'evaluated'">
                                    <div class="dialog" id="shadow">
                                        <div class="dialog--header">
                                            <xsl:choose>
                                                <xsl:when test="$self/@state = 'won'">
                                                  <a id="win"> You won +<xsl:value-of
                                                  select="$self/profit"/>! </a>
                                                </xsl:when>
                                                <xsl:when test="$self/@state = 'lost'">
                                                  <a id="lose"> You lost -<xsl:value-of
                                                  select="$self/profit * -1"/>! </a>
                                                </xsl:when>
                                        ...
                                        <form
                                            action="/xforms-multiclient/games/{/game/@id}/newRound"
                                            method="POST" target="hiddenFrame">
                        ...
                        <xsl:otherwise>
                            ...
                            <div class="dialog" id="shadow">
                                <div class="dialog--header"> Spectating mode </div>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <form class="join"
                                            action="/xforms-multiclient/games/{/game/@id}/join"
                                            method="POST" target="hiddenFrame">
